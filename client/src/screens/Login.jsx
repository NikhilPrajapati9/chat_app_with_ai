      ...
      <div className="w-full max-w-md">
        <div className="backdrop-blur-sm bg-white/10 rounded-2xl px-8 pt-8 pb-4 shadow-xl border border-white/10">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className={`not-first:w-full cursor-pointer mt-5 py-3 px-4 flex justify-center items-center bg-gradient-to-r from-gray-600 via-slate-600 to-zinc-500 text-white rounded-lg shadow-lg hover:from-slate-700 hover:via-zinc-700 hover:to-gray-600 transition-all duration-300 font-medium ${
